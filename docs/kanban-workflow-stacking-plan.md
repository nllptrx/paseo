...
- **"Create Orchestrator"** action on the board header menu of the Kanbans view. One tap provisions a workspace on the project root, starts the primary agent session, and links it to the kanban. Optional and lazy: a kanban works fully without one; a default user never meets the concept.
