export const en = {
  ...
  tasks: {
    ...
    start: {
      ...
      confirmTitle: "Start this plan?",
      confirmMessage: "“{{step}}” runs on {{agent}}.",
      confirmAction: "Start",
    },
    feed: {
      ...
      legacyNoteWarning: "Update this host before using mentions in notes",
      send: "Send",
      tab: "Feed",
      toggle: "Board feed",
    },
    ...
    detail: {
      ...
      reviewerEmpty: "No agent presets yet — create one to let an agent review",
