...
export const ptBR: TranslationResources = {
  ...
  kanban: {
    ...
    planForm: {
      ...
      workspaceLabel: "Workspace",
      triggerLabel: "Começa",
      triggerHint: "Imediato roda assim que a etapa anterior termina.",
      workspace: {
        worktree: "Novo worktree",
        worktreePerAgent: "Um worktree por agente",
        reusePrevious: "Workspace da etapa anterior",
        existing: "Um workspace existente",
      },
      trigger: {
        manual: "Manualmente",
