...
export const ptBR: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      instructionsPlaceholder: "Instruções permanentes (opcional)",
      newWorktree: "Nova worktree",
      projectDefault: "Onde o cartão é trabalhado",
      save: "Salvar predefinição",
      menu: "Predefinições",
    },
    start: {
      blocked: "Bloqueada por {{titles}}. Termine isso primeiro.",
      confirmTitle: "Iniciar este plano?",
      confirmMessage: "“{{step}}” roda em {{agent}}.",
    ...
    feed: {
      ...
      legacyNoteWarning: "Atualize este host antes de usar menções nas notas",
      send: "Enviar",
      tab: "Feed",
      toggle: "Feed do quadro",
    },
    screen: {
      title: "Tarefas",
    ...
    form: {
      submitWithWorkflow: "Adicionar workflow",
      title: "Nova tarefa",
      submit: "Criar",
    ...
    workflow: {
      ...
      verifyLabel: "Verificar com",
      verifyHint: "Um comando que precisa passar, executado no espaço de trabalho da etapa.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "Limite de tempo",
      timeoutHint: "Minutos até a etapa ser parada. Vazio significa sem limite.",
      timeoutPlaceholder: "30",
      addToTask: "Adicionar workflow",
      title: "Workflow da tarefa",
      submit: "Salvar workflow",
      promptLabel: "Prompt",
      ...
      removeStep: "Remover a etapa",
      moveStepUp: "Subir a etapa",
      moveStepDown: "Descer a etapa",
      workspaceLabel: "Espaço de trabalho",
      triggerLabel: "Começa",
      triggerHint: "Imediatamente começa assim que a etapa anterior termina.",
      workspace: {
        worktree: "Nova worktree",
        worktreePerAgent: "Uma worktree por agente",
        reusePrevious: "O espaço de trabalho da etapa anterior",
        existing: "Um espaço de trabalho existente",
      },
      trigger: {
        manual: "Manualmente",
        immediate: "Imediatamente",
        schedule: "Em um agendamento",
      },
    },
    detail: {
      reviewerBadge: "revisor",
      reviewerHeading: "Revisão",
      reviewerNone: "Uma pessoa revisa",
      reviewerEmpty: "Ainda não há presets de agente: crie um para que um agente revise",
      reviewerPick: "Revisado por",
      workflowHeading: "Workflow",
      workflowAdd: "Adicionar workflow",
      workflowEdit: "Editar o workflow",
      stepStatus: {
        queued: "Aguardando uma vaga",
      ...
      commentNotify_one: "Enviar ao agente",
      commentNotify_other: "Enviar a {{count}} agentes",
      blockedHeading: "Aguardando",
      startHeading: "Começar o trabalho",
  ...
  kanban: {
    ...
    screen: {
      ...
      backToOverview: "Todos os kanbans",
      boardMissing: "Esse kanban não está mais disponível.",
    },
    board: {
  ...
  sidebar: {
    ...
    kanban: {
      unbounded: "Unbounded",
      addToKanban: {
        success: "Adicionado ao Kanban",
        alreadyTracked: "Este espaço de trabalho já está no Kanban",
        createFailed: "Não foi possível criar o kanban",
        noColumns: "O Kanban não tem colunas onde adicionar o plano",
        noProvider: "Nenhum provedor de agente disponível neste host",
      },
    },
    host: {
      noHost: "Nenhum host",
