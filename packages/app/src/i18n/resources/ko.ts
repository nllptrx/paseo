...
export const ko: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      newHeading: "새 프리셋",
      namePlaceholder: "이름",
      instructionsPlaceholder: "상시 지침 (선택)",
      newWorktree: "새 worktree",
      projectDefault: "카드가 작업되는 곳",
      save: "프리셋 저장",
      menu: "프리셋",
    },
    start: {
      blocked: "{{titles}}에 막혀 있습니다. 그것부터 끝내세요.",
      confirmTitle: "이 플랜을 시작할까요?",
      confirmMessage: "“{{step}}”을(를) {{agent}}에서 실행합니다.",
      confirmAction: "시작",
    },
    feed: {
      ...
      legacyNoteWarning: "노트에서 멘션을 사용하기 전에 호스트를 업데이트하세요",
      send: "보내기",
      tab: "피드",
      toggle: "보드 피드",
    },
    ...
    workflow: {
      ...
      verifyLabel: "검증 명령",
      verifyHint: "통과해야 하는 명령. 단계의 워크스페이스에서 실행됩니다.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "시간 제한",
      timeoutHint: "단계를 중지하기까지의 분. 비우면 제한이 없습니다.",
      ...
      stepHeading: "{{total}}단계 중 {{index}}단계",
      stepNameLabel: "단계 이름",
      ...
      triggerLabel: "시작",
      triggerHint: "'즉시'는 이전 단계가 끝나는 대로 시작합니다.",
      workspace: {
        worktree: "새 worktree",
        worktreePerAgent: "에이전트마다 worktree",
        reusePrevious: "이전 단계의 워크스페이스",
        existing: "기존 워크스페이스",
      },
      trigger: {
        manual: "수동으로",
    ...
    detail: {
      reviewerBadge: "리뷰어",
      reviewerHeading: "리뷰",
      reviewerNone: "사람이 리뷰합니다",
      reviewerEmpty: "에이전트 프리셋이 없습니다. 만들면 에이전트가 리뷰합니다",
      reviewerPick: "리뷰 담당",
      workflowHeading: "Workflow",
      workflowAdd: "워크플로 추가",
      workflowEdit: "워크플로 편집",
      stepStatus: {
        queued: "빈 자리를 기다리는 중",
        interrupted: "중단됨",
        canceled: "취소됨",
      ...
      commentNotify_one: "에이전트에게 보내기",
      commentNotify_other: "에이전트 {{count}}명에게 보내기",
      blockedHeading: "대기 중",
      startHeading: "작업 시작",
      blockedBadge: "차단됨",
      menuLabel: "세부 정보",
  ...
  sidebar: {
    ...
    kanban: {
      ...
      addToKanban: {
        success: "칸반에 추가했습니다",
        alreadyTracked: "이 워크스페이스는 이미 칸반에 있습니다",
        createFailed: "칸반을 만들 수 없습니다",
        noColumns: "플랜을 추가할 칸반 열이 없습니다",
        noProvider: "이 호스트에 사용할 수 있는 에이전트 제공자가 없습니다",
      },
    },
    host: {
      noHost: "호스트 없음",
