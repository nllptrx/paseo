...
export const ar: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      instructionsPlaceholder: "تعليمات دائمة (اختياري)",
      newWorktree: "worktree جديد",
      projectDefault: "حيث تُنفَّذ البطاقة",
      save: "حفظ الإعداد",
      menu: "الإعدادات المحفوظة",
    },
    start: {
      blocked: "محجوبة بـ {{titles}}. أنهِ ذلك أولًا.",
      confirmTitle: "هل تبدأ هذه الخطة؟",
      confirmMessage: "«{{step}}» تعمل عبر {{agent}}.",
      confirmAction: "ابدأ",
    },
    feed: {
      ...
      legacyNoteWarning: "حدّث هذا المضيف قبل استخدام الإشارات في الملاحظات",
      send: "إرسال",
      tab: "التدفق",
      toggle: "تدفق اللوحة",
    },
    ...
    form: {
      submitWithWorkflow: "إضافة سير عمل",
      title: "مهمة جديدة",
      submit: "إنشاء",
    ...
    workflow: {
      ...
      verifyLabel: "التحقق بـ",
      verifyHint: "أمر يجب أن ينجح، يُنفَّذ في مساحة عمل الخطوة.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "الحد الزمني",
      timeoutHint: "عدد الدقائق قبل إيقاف الخطوة. الفراغ يعني بلا حد.",
      timeoutPlaceholder: "30",
      addToTask: "إضافة سير عمل",
      title: "سير عمل المهمة",
      submit: "حفظ سير العمل",
      promptLabel: "Prompt",
      ...
      stepNamePlaceholder: "ما تفعله هذه الخطوة",
      removeStep: "حذف الخطوة",
      moveStepUp: "تحريك الخطوة لأعلى",
      moveStepDown: "تحريك الخطوة لأسفل",
      workspaceLabel: "مساحة العمل",
      triggerLabel: "البدء",
      triggerHint: "«فورًا» تبدأ بمجرد انتهاء الخطوة السابقة.",
      workspace: {
        worktree: "worktree جديد",
        worktreePerAgent: "worktree لكل وكيل",
        reusePrevious: "مساحة عمل الخطوة السابقة",
        existing: "مساحة عمل موجودة",
      },
      trigger: {
        manual: "يدويًا",
        immediate: "فورًا",
    ...
    detail: {
      reviewerBadge: "مراجِع",
      reviewerHeading: "مراجعة",
      reviewerNone: "يراجعها شخص",
      reviewerEmpty: "لا توجد إعدادات وكيل بعد — أنشئ واحدًا ليقوم وكيل بالمراجعة",
      reviewerPick: "يراجعها",
      workflowHeading: "Workflow",
      workflowAdd: "إضافة سير عمل",
      workflowEdit: "تعديل سير العمل",
      stepStatus: {
        queued: "في انتظار مكان شاغر",
        interrupted: "انقطعت",
        canceled: "أُلغيت",
        pending: "لم تبدأ",
        running: "قيد التشغيل",
      ...
      commentNotify_one: "إرسال إلى الوكيل",
      commentNotify_other: "إرسال إلى {{count}} وكلاء",
      blockedHeading: "في انتظار",
      startHeading: "ابدأ العمل",
      blockedBadge: "محجوبة",
      menuLabel: "التفاصيل",
      statusLabel: "الحالة",
      priorityLabel: "الأولوية",
      priorityNone: "بلا أولوية",
      labelsHeading: "التسميات",
      due: "الاستحقاق {{date}}",
      agentsHeading: "Agents",
      commentsHeading: "الموجز",
      commentPlaceholder: "اكتب تحديثًا",
      commentSend: "نشر",
    },
  },
  kanban: {
  ...
  sidebar: {
    ...
    kanban: {
      unbounded: "Unbounded",
      addToKanban: {
        success: "أُضيفت إلى الكانبان",
        alreadyTracked: "مساحة العمل هذه موجودة بالفعل على الكانبان",
        createFailed: "تعذّر إنشاء الكانبان",
        noColumns: "لا توجد أعمدة في الكانبان لإضافة الخطة إليها",
        noProvider: "لا يوجد مزوّد وكلاء متاح على هذا المضيف",
      },
    },
    host: {
      noHost: "لا مضيف",
    ...
    project: {
      actions: {
        ...
        addToKanban: "إضافة إلى الكانبان",
