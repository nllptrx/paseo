...
export const ar: TranslationResources = {
  ...
  kanban: {
    ...
    planForm: {
      ...
      moveStepUp: "نقل لأعلى",
      moveStepDown: "نقل لأسفل",
      workspaceLabel: "مساحة العمل",
      triggerLabel: "تبدأ",
      triggerHint: "فوري يعمل بمجرد انتهاء الخطوة السابقة.",
      workspace: {
        worktree: "شجرة عمل جديدة",
        worktreePerAgent: "شجرة عمل لكل وكيل",
        reusePrevious: "مساحة الخطوة السابقة",
