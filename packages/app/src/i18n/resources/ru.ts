...
export const ru: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      instructionsPlaceholder: "Постоянные инструкции (необязательно)",
      newWorktree: "Новый worktree",
      projectDefault: "Там, где ведётся работа по карточке",
      save: "Сохранить пресет",
      menu: "Пресеты",
    },
    start: {
      blocked: "Заблокировано: {{titles}}. Сначала завершите это.",
      confirmTitle: "Запустить этот план?",
      confirmMessage: "«{{step}}» выполняется на {{agent}}.",
    ...
    feed: {
      ...
      legacyNoteWarning: "Обновите этот хост перед использованием упоминаний в заметках",
      send: "Отправить",
      tab: "Лента",
      toggle: "Лента доски",
    },
    ...
    form: {
      submitWithWorkflow: "Добавить workflow",
      title: "Новая задача",
      submit: "Создать",
    ...
    workflow: {
      ...
      verifyLabel: "Проверять командой",
      verifyHint: "Команда, которая должна пройти, выполняется в рабочем пространстве шага.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "Ограничение по времени",
      timeoutHint: "Через сколько минут шаг будет остановлен. Пусто — без ограничения.",
      timeoutPlaceholder: "30",
      addToTask: "Добавить workflow",
      title: "Workflow задачи",
      submit: "Сохранить workflow",
      promptLabel: "Prompt",
      ...
      stepsHeading_other: "{{count}} шагов",
      ...
      triggerLabel: "Запуск",
      triggerHint: "«Сразу» запускает шаг, как только закончится предыдущий.",
      workspace: {
        worktree: "Новый worktree",
        worktreePerAgent: "Отдельный worktree на агента",
        reusePrevious: "Рабочее пространство предыдущего шага",
        existing: "Существующее рабочее пространство",
      },
      trigger: {
        manual: "Вручную",
        immediate: "Сразу",
    ...
    detail: {
      reviewerBadge: "ревьюер",
      reviewerHeading: "Ревью",
      reviewerNone: "Проверяет человек",
      reviewerEmpty: "Пресетов агентов пока нет — создайте один, чтобы проверял агент",
      reviewerPick: "Проверяет",
      workflowHeading: "Workflow",
      workflowAdd: "Добавить workflow",
      workflowEdit: "Изменить workflow",
      stepStatus: {
      ...
      commentNotify_one: "Отправить агенту",
      commentNotify_other: "Отправить {{count}} агентам",
      blockedHeading: "Ожидает",
      startHeading: "Начать работу",
      ...
      commentsHeading: "Лента",
      commentPlaceholder: "Написать обновление",
      commentSend: "Опубликовать",
    },
  },
  kanban: {
    panel: {
  ...
  sidebar: {
    ...
    kanban: {
      unbounded: "Unbounded",
      addToKanban: {
        success: "Добавлено на Kanban",
        alreadyTracked: "Это рабочее пространство уже есть на Kanban",
        createFailed: "Не удалось создать kanban",
        noColumns: "На Kanban нет колонок, куда добавить план",
        noProvider: "На этом хосте нет доступного провайдера агентов",
      },
    },
    host: {
      noHost: "Нет хоста",
    ...
    project: {
      actions: {
        ...
        addToKanban: "Добавить на Kanban",
