...
export const ru: TranslationResources = {
  ...
  kanban: {
    ...
    planForm: {
      ...
      moveStepUp: "Переместить вверх",
      moveStepDown: "Переместить вниз",
      workspaceLabel: "Рабочее пространство",
      triggerLabel: "Запуск",
      triggerHint: "«Сразу» запускается, как только завершится предыдущий шаг.",
      workspace: {
        worktree: "Новый worktree",
        worktreePerAgent: "Worktree на каждого агента",
        reusePrevious: "Пространство предыдущего шага",
        existing: "Существующее пространство",
      },
      trigger: {
        manual: "Вручную",
        immediate: "Сразу",
