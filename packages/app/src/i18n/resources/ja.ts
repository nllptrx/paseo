...
export const ja: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      newHeading: "新しいプリセット",
      namePlaceholder: "名前",
      instructionsPlaceholder: "常時の指示（任意）",
      newWorktree: "新しい worktree",
      projectDefault: "カードが作業される場所",
      save: "プリセットを保存",
      menu: "プリセット",
    },
    start: {
      blocked: "{{titles}} にブロックされています。先にそちらを終えてください。",
      confirmTitle: "このプランを開始しますか？",
      confirmMessage: "「{{step}}」を {{agent}} で実行します。",
      confirmAction: "開始",
    },
    feed: {
      ...
      legacyNoteWarning: "ノートでメンションを使う前にホストを更新してください",
      send: "送信",
      tab: "フィード",
      toggle: "ボードフィード",
    },
    ...
    workflow: {
      ...
      verifyLabel: "検証コマンド",
      verifyHint: "成功しなければならないコマンド。ステップのワークスペースで実行されます。",
      verifyPlaceholder: "npm test",
      timeoutLabel: "時間制限",
      timeoutHint: "ステップを停止するまでの分数。空欄は無制限です。",
      ...
      removeStep: "ステップを削除",
      moveStepUp: "ステップを上へ",
      moveStepDown: "ステップを下へ",
      workspaceLabel: "ワークスペース",
      triggerLabel: "開始",
      triggerHint: "「すぐに」は前のステップが終わり次第開始します。",
      workspace: {
        worktree: "新しい worktree",
        worktreePerAgent: "エージェントごとに worktree",
        reusePrevious: "前のステップのワークスペース",
        existing: "既存のワークスペース",
      },
      trigger: {
        manual: "手動で",
    ...
    detail: {
      reviewerBadge: "レビュアー",
      reviewerHeading: "レビュー",
      reviewerNone: "人がレビューする",
      reviewerEmpty: "エージェントのプリセットがありません。作成するとエージェントがレビューします",
      reviewerPick: "レビュー担当",
      workflowHeading: "Workflow",
      workflowAdd: "ワークフローを追加",
      ...
      commentNotify_one: "エージェントに送信",
      commentNotify_other: "{{count}} 体のエージェントに送信",
      blockedHeading: "待機中",
      startHeading: "作業を開始",
      blockedBadge: "ブロック中",
      menuLabel: "詳細",
      ...
      commentsHeading: "フィード",
      commentPlaceholder: "更新を書く",
      commentSend: "投稿",
    },
  },
  kanban: {
  ...
  sidebar: {
    ...
    kanban: {
      ...
      addToKanban: {
        success: "カンバンに追加しました",
        alreadyTracked: "このワークスペースはすでにカンバンにあります",
        createFailed: "カンバンを作成できませんでした",
        noColumns: "プランを追加する列がカンバンにありません",
        noProvider: "このホストに利用できるエージェントプロバイダーがありません",
      },
    },
    host: {
      noHost: "ホストなし",
