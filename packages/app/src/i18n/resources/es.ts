...
export const es: TranslationResources = {
  ...
  tasks: {
    ...
    workflow: {
      ...
      triggerLabel: "Starts",
      triggerHint: "Immediate runs as soon as the previous step finishes.",
      workspace: {
        worktree: "New worktree",
        worktreePerAgent: "A worktree per agent",
        reusePrevious: "Previous step's workspace",
        existing: "An existing workspace",
      },
      trigger: {
        manual: "Manually",
  ...
  kanban: {
    ...
    planSheet: {
      ...
      gateBlocked: "Esperando al paso anterior",
    },
    planForm: {
      title: "Nuevo plan",
      titleLabel: "Título",
      ...
      triggerLabel: "Empieza",
      triggerHint: "Inmediato se ejecuta en cuanto termina el paso anterior.",
      workspace: {
        worktree: "Nuevo worktree",
        worktreePerAgent: "Un worktree por agente",
        reusePrevious: "Espacio del paso anterior",
        existing: "Un espacio existente",
      },
      trigger: {
        manual: "Manualmente",
