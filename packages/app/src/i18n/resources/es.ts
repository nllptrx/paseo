...
export const es: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      instructionsPlaceholder: "Instrucciones permanentes (opcional)",
      newWorktree: "Nuevo worktree",
      projectDefault: "Donde se trabaja la tarjeta",
      save: "Guardar ajuste",
      menu: "Ajustes",
    },
    start: {
      blocked: "Bloqueada por {{titles}}. Termina eso primero.",
      confirmTitle: "¿Iniciar este plan?",
      confirmMessage: "«{{step}}» se ejecuta en {{agent}}.",
    ...
    feed: {
      ...
      legacyNoteWarning: "Actualiza este host antes de usar menciones en las notas",
      send: "Enviar",
      tab: "Feed",
      toggle: "Feed del tablero",
    },
    screen: {
      title: "Tareas",
      empty: "Aún no hay tareas",
      noHost: "Ningún host conectado",
      unsupported: "Este host no tiene gestor de tareas.",
    ...
    form: {
      submitWithWorkflow: "Añadir workflow",
      title: "Nueva tarea",
      submit: "Crear",
      taskTitleLabel: "Título",
      taskTitlePlaceholder: "¿Qué hay que hacer?",
      firstProjectHint: "Este host aún no tiene proyecto de tareas, así que también se creará uno.",
      projectNameLabel: "Nombre del proyecto",
      projectNamePlaceholder: "Paseo",
      prefixLabel: "Prefijo",
      prefixHint: "Mayúsculas, hasta 8 letras. Las tareas se leen PSE-42.",
    ...
    workflow: {
      ...
      verifyLabel: "Verificar con",
      verifyHint: "Un comando que debe pasar, ejecutado en el espacio de trabajo del paso.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "Límite de tiempo",
      timeoutHint: "Minutos antes de detener el paso. Vacío significa sin límite.",
      timeoutPlaceholder: "30",
      addToTask: "Añadir workflow",
      title: "Workflow de la tarea",
      submit: "Guardar workflow",
      promptLabel: "Prompt",
      ...
      triggerLabel: "Arranca",
      triggerHint: "Inmediatamente arranca en cuanto termina el paso anterior.",
      workspace: {
        worktree: "Nuevo worktree",
        worktreePerAgent: "Un worktree por agente",
        reusePrevious: "El espacio de trabajo del paso anterior",
        existing: "Un espacio de trabajo existente",
      },
      trigger: {
        manual: "Manualmente",
        immediate: "Inmediatamente",
        schedule: "Según una programación",
      },
    },
    detail: {
      reviewerBadge: "revisor",
      reviewerHeading: "Revisión",
      reviewerNone: "Revisa una persona",
      reviewerEmpty: "Aún no hay presets de agente: crea uno para que revise un agente",
      reviewerPick: "Revisado por",
      workflowHeading: "Workflow",
      workflowAdd: "Añadir workflow",
      workflowEdit: "Editar el workflow",
      stepStatus: {
        queued: "Esperando un hueco",
      ...
      commentNotify_one: "Enviar al agente",
      commentNotify_other: "Enviar a {{count}} agentes",
      blockedHeading: "Esperando a",
      startHeading: "Empezar a trabajar",
      blockedBadge: "Bloqueada",
      menuLabel: "Detalles",
      statusLabel: "Estado",
      priorityLabel: "Prioridad",
      priorityNone: "Sin prioridad",
      labelsHeading: "Etiquetas",
      due: "Vence {{date}}",
      agentsHeading: "Agents",
      commentsHeading: "Feed",
      commentPlaceholder: "Escribe una actualización",
      commentSend: "Publicar",
    },
  },
  kanban: {
    panel: {
    ...
    screen: {
      ...
      backToOverview: "Todos los kanbans",
      boardMissing: "Ese kanban ya no está disponible.",
    },
    board: {
  ...
  sidebar: {
    ...
    kanban: {
      unbounded: "Unbounded",
      addToKanban: {
        success: "Añadido al Kanban",
        alreadyTracked: "Este espacio de trabajo ya está en el Kanban",
        createFailed: "No se pudo crear el kanban",
        noColumns: "El Kanban no tiene columnas donde añadir el plan",
        noProvider: "No hay proveedor de agentes disponible en este host",
      },
    },
    host: {
