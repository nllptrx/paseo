...
export const es: TranslationResources = {
  ...
  tasks: {
    ...
    workflow: {
      ...
      verifyLabel: "Verify with",
      verifyHint: "A command that has to pass, run in the step's workspace.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "Time limit",
      timeoutHint: "Minutes before the step is stopped. Empty means no limit.",
