...
export const fr: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      effortLabel: "Effort",
      effortDefault: "Valeur par défaut du modèle",
      noEffortOptions: "Aucune option d’effort",
      permissionLabel: "Mode d’autorisation",
      permissionDefault: "Valeur par défaut du fournisseur",
      noPermissionOptions: "Aucun mode d’autorisation",
      fastEnabled: "Rapide",
      nameLabel: "Nom",
      ...
      newHeading: "Nouveau préréglage",
      namePlaceholder: "Nom",
      instructionsPlaceholder: "Instructions permanentes (facultatif)",
      newWorktree: "Nouveau worktree",
      projectDefault: "Là où la carte est traitée",
      save: "Enregistrer le préréglage",
      menu: "Préréglages",
    },
    start: {
      blocked: "Bloquée par {{titles}}. Terminez cela d'abord.",
      confirmTitle: "Lancer ce plan ?",
      confirmMessage: "« {{step}} » s'exécute sur {{agent}}.",
    ...
    feed: {
      ...
      legacyNoteWarning: "Mettez à jour cet hôte avant d'utiliser des mentions dans les notes",
      send: "Envoyer",
      tab: "Fil",
      toggle: "Fil du tableau",
    },
    screen: {
      title: "Tâches",
      empty: "Aucune tâche pour l'instant",
    ...
    form: {
      submitWithWorkflow: "Ajouter un workflow",
    ...
    workflow: {
      ...
      verifyLabel: "Vérifier avec",
      verifyHint: "Une commande qui doit réussir, exécutée dans l'espace de travail de l'étape.",
      verifyPlaceholder: "npm test",
      timeoutLabel: "Limite de temps",
      timeoutHint: "Minutes avant l'arrêt de l'étape. Vide signifie sans limite.",
      timeoutPlaceholder: "30",
      addToTask: "Ajouter un workflow",
      title: "Workflow de la tâche",
      submit: "Enregistrer le workflow",
      promptLabel: "Prompt",
      ...
      stepsHeading_one: "{{count}} étape",
      stepsHeading_other: "{{count}} étapes",
      stepHeading: "Étape {{index}} sur {{total}}",
      stepNameLabel: "Nom de l'étape",
      stepNamePlaceholder: "Ce que fait cette étape",
      removeStep: "Supprimer l'étape",
      moveStepUp: "Monter l'étape",
      moveStepDown: "Descendre l'étape",
      workspaceLabel: "Espace de travail",
      triggerLabel: "Démarre",
      triggerHint: "Immédiatement démarre dès que l'étape précédente se termine.",
      workspace: {
        worktree: "Nouveau worktree",
        worktreePerAgent: "Un worktree par agent",
        reusePrevious: "L'espace de travail de l'étape précédente",
        existing: "Un espace de travail existant",
      },
      trigger: {
        manual: "Manuellement",
        immediate: "Immédiatement",
        schedule: "Selon une planification",
      },
    },
    detail: {
      reviewerBadge: "relecteur",
      reviewerHeading: "Revue",
      reviewerNone: "Une personne relit",
      reviewerEmpty: "Aucun preset d'agent : créez-en un pour qu'un agent relise",
      reviewerPick: "Relu par",
      workflowHeading: "Workflow",
      workflowAdd: "Ajouter un workflow",
      workflowEdit: "Modifier le workflow",
      stepStatus: {
        queued: "En attente d'un créneau",
      ...
      commentNotify_one: "Envoyer à l'agent",
      commentNotify_other: "Envoyer à {{count}} agents",
      blockedHeading: "En attente de",
      startHeading: "Démarrer le travail",
      blockedBadge: "Bloquée",
      menuLabel: "Détails",
      statusLabel: "Statut",
      priorityLabel: "Priorité",
      priorityNone: "Aucune priorité",
      labelsHeading: "Étiquettes",
      due: "Échéance {{date}}",
      agentsHeading: "Agents",
      commentsHeading: "Fil",
      commentPlaceholder: "Écrire une mise à jour",
      commentSend: "Publier",
    },
  },
  kanban: {
  ...
  sidebar: {
    ...
    kanban: {
      unbounded: "Unbounded",
      addToKanban: {
        success: "Ajouté au Kanban",
        alreadyTracked: "Cet espace de travail est déjà suivi sur le Kanban",
        createFailed: "Impossible de créer le kanban",
        noColumns: "Le Kanban n'a aucune colonne où ajouter le plan",
        noProvider: "Aucun fournisseur d'agent disponible sur cet hôte",
      },
    },
    host: {
      noHost: "Aucun hôte",
