...
export const fr: TranslationResources = {
  ...
  kanban: {
    ...
    planSheet: {
      ...
      gateBlocked: "En attente de l'étape précédente",
    },
    planForm: {
      title: "Nouveau plan",
      titleLabel: "Titre",
      ...
      triggerHint: "Immédiat démarre dès que l'étape précédente est terminée.",
      workspace: {
        worktree: "Nouveau worktree",
        worktreePerAgent: "Un worktree par agent",
        reusePrevious: "Espace de l'étape précédente",
        existing: "Un espace existant",
      },
      trigger: {
        manual: "Manuellement",
