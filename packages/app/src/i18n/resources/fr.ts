...
export const fr: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      addIssueOrMr: "Ajouter un problème ou MR",
    ...
    github: {
      ...
      searchPlaceholderMr: "Problèmes de recherche et MR...",
      title: "Joindre le problème ouPR",
      titleMr: "Joindre le problème ou MR",
    },
  },
  agentControls: {
    provider: {
  ...
  workspace: {
    ...
    git: {
      actions: {
        ...
        createMr: {
          label: "Créer MR",
          pending: "Création de MR...",
          success: "MR créé",
        },
        mergeMr: {
          squash: "Fusionner MR (squash)",
          merge: "Fusionner MR (merge)",
          rebase: "Fusionner MR (rebase)",
          pending: "Fusion de MR...",
          success: "MR fusionné",
        },
        autoMerge: {
      ...
      gitlab: {
        setupCallout:
          "Les fonctionnalités GitLab ne sont pas disponibles. Assurez-vous que la CLI glab est installée et authentifiée sur cet hôte.",
      },
    },
  },
  sidebar: {
