...
export const zhCN: TranslationResources = {
  ...
  tasks: {
    presets: {
      ...
      newHeading: "新建预设",
      namePlaceholder: "名称",
      instructionsPlaceholder: "常驻说明（可选）",
      newWorktree: "新建 worktree",
      projectDefault: "卡片被处理的位置",
      save: "保存预设",
      menu: "预设",
    },
    start: {
      ...
      confirmTitle: "开始这个计划？",
      confirmMessage: "“{{step}}”将在 {{agent}} 上运行。",
      confirmAction: "开始",
    },
    feed: {
      ...
      legacyNoteWarning: "请先更新主机，再在备注中使用提及",
      send: "发送",
      tab: "动态",
      toggle: "看板动态",
    },
    ...
    workflow: {
      ...
      verifyLabel: "验证命令",
      verifyHint: "必须通过的命令，在该步骤的工作区中运行。",
      verifyPlaceholder: "npm test",
      timeoutLabel: "时间上限",
      timeoutHint: "多少分钟后停止该步骤。留空表示不限。",
      ...
      addStep: "添加步骤",
      stepsHeading_one: "{{count}} 个步骤",
      stepsHeading_other: "{{count}} 个步骤",
      ...
      workspaceLabel: "工作区",
      triggerLabel: "启动方式",
      triggerHint: "“立即”会在上一步结束后马上开始。",
      workspace: {
        worktree: "新建 worktree",
        worktreePerAgent: "每个 Agent 一个 worktree",
        reusePrevious: "上一步骤的工作区",
        existing: "已有的工作区",
      },
      trigger: {
        manual: "手动",
    ...
    detail: {
      ...
      reviewerHeading: "审查",
      reviewerNone: "由人来审查",
      reviewerEmpty: "还没有智能体预设，创建一个即可让智能体审查",
      reviewerPick: "审查者",
      ...
      commentNotify_one: "发送给 Agent",
      commentNotify_other: "发送给 {{count}} 个 Agent",
      blockedHeading: "等待",
      startHeading: "开始工作",
      blockedBadge: "已阻塞",
      menuLabel: "详情",
  ...
  sidebar: {
    ...
    kanban: {
      ...
      addToKanban: {
        success: "已添加到看板",
        alreadyTracked: "该工作区已在看板上",
        createFailed: "无法创建看板",
        noColumns: "看板没有可添加计划的列",
        noProvider: "此主机上没有可用的 Agent 提供方",
      },
    },
    host: {
      noHost: "没有 Host",
