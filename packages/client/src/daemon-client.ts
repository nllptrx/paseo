...
>["payload"];
type KanbanGetPayload = Extract<SessionOutboundMessage, { type: "kanban.get.response" }>["payload"];
type KanbanCreatePayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.create.response" }
>["payload"];
type KanbanUpdatePayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.update.response" }
>["payload"];
type KanbanArchivePayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.archive.response" }
>["payload"];
type KanbanPlanCreatePayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.plan.create.response" }
>["payload"];
type KanbanPlanUpdatePayload = Extract<
  SessionOutboundMessage,
...
>["payload"];
type KanbanStepRunPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.step.run.response" }
>["payload"];
type KanbanStepRetryPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.step.retry.response" }
>["payload"];
type KanbanStepSkipPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.step.skip.response" }
>["payload"];
type KanbanStepCancelPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.step.cancel.response" }
>["payload"];
type KanbanOrchestratorProvisionPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.orchestrator.provision.response" }
>["payload"];
type KanbanOrchestratorUnlinkPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.orchestrator.unlink.response" }
>["payload"];
type KanbanOrchestratorListPeersPayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.orchestrator.list_peers.response" }
>["payload"];
type KanbanSubscribePayload = Extract<
  SessionOutboundMessage,
  { type: "kanban.subscribe.response" }
>["payload"];
type KanbanUnsubscribePayload = Extract<
  SessionOutboundMessage,
...
export interface UpdateKanbanPlanOptions {
  kanbanId: string;
  parentPlanId?: string | null;
  planId: string;
  title?: string;
...
export interface KanbanStepActionOptions extends KanbanPlanIdentifier {
  stepId: string;
}
export interface KanbanIdentifier {
  kanbanId: string;
  requestId?: string;
}
...
export class DaemonClient {
  ...
  async kanbanList(requestId?: string): Promise<KanbanListPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.list.response">({
      requestId,
      message: { type: "kanban.list.request" },
    });
  }

  async kanbanGet(kanbanId: string, requestId?: string): Promise<KanbanGetPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.get.response">({
      requestId,
      message: { type: "kanban.get.request", kanbanId },
    });
  }

  async kanbanCreate(options: CreateKanbanOptions): Promise<KanbanCreatePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.create.response">({
      requestId: options.requestId,
      message: {
  ...
  async kanbanUpdate(options: UpdateKanbanOptions): Promise<KanbanUpdatePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.update.response">({
      requestId: options.requestId,
      message: {
  ...
  async kanbanArchive(options: KanbanIdentifier): Promise<KanbanArchivePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.archive.response">({
      requestId: options.requestId,
      message: { type: "kanban.archive.request", kanbanId: options.kanbanId },
    });
  }

  async kanbanPlanCreate(options: CreateKanbanPlanOptions): Promise<KanbanPlanCreatePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.plan.create.response">({
      requestId: options.requestId,
      message: {
  ...
  async kanbanPlanUpdate(options: UpdateKanbanPlanOptions): Promise<KanbanPlanUpdatePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.plan.update.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.plan.update.request",
        kanbanId: options.kanbanId,
  ...
  async kanbanPlanArchive(options: KanbanPlanIdentifier): Promise<KanbanPlanArchivePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.plan.archive.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.plan.archive.request",
        kanbanId: options.kanbanId,
        planId: options.planId,
        ...(options.parentPlanId !== undefined ? { parentPlanId: options.parentPlanId } : {}),
      },
  ...
  async kanbanStepRun(options: KanbanStepActionOptions): Promise<KanbanStepRunPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.step.run.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.step.run.request",
        kanbanId: options.kanbanId,
        planId: options.planId,
  ...
  async kanbanStepRetry(options: KanbanStepActionOptions): Promise<KanbanStepRetryPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.step.retry.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.step.retry.request",
        kanbanId: options.kanbanId,
        planId: options.planId,
        stepId: options.stepId,
        ...(options.parentPlanId !== undefined ? { parentPlanId: options.parentPlanId } : {}),
  ...
  async kanbanStepSkip(options: KanbanStepActionOptions): Promise<KanbanStepSkipPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.step.skip.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.step.skip.request",
        kanbanId: options.kanbanId,
        planId: options.planId,
        stepId: options.stepId,
        ...(options.parentPlanId !== undefined ? { parentPlanId: options.parentPlanId } : {}),
  ...
  async kanbanStepCancel(options: KanbanStepActionOptions): Promise<KanbanStepCancelPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.step.cancel.response">({
      requestId: options.requestId,
      message: {
        type: "kanban.step.cancel.request",
        kanbanId: options.kanbanId,
        planId: options.planId,
        stepId: options.stepId,
        ...(options.parentPlanId !== undefined ? { parentPlanId: options.parentPlanId } : {}),
  ...
  async kanbanOrchestratorProvision(
    options: KanbanIdentifier,
  ): Promise<KanbanOrchestratorProvisionPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.orchestrator.provision.response">({
      requestId: options.requestId,
      message: { type: "kanban.orchestrator.provision.request", kanbanId: options.kanbanId },
    });
  }

  async kanbanOrchestratorUnlink(
    options: KanbanIdentifier,
  ): Promise<KanbanOrchestratorUnlinkPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.orchestrator.unlink.response">({
      requestId: options.requestId,
      message: { type: "kanban.orchestrator.unlink.request", kanbanId: options.kanbanId },
    });
  }

  async kanbanOrchestratorListPeers(
    requestId?: string,
  ): Promise<KanbanOrchestratorListPeersPayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.orchestrator.list_peers.response">({
      requestId,
      message: { type: "kanban.orchestrator.list_peers.request" },
    });
  }

  async kanbanSubscribe(requestId?: string): Promise<KanbanSubscribePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.subscribe.response">({
      requestId,
      message: { type: "kanban.subscribe.request" },
    });
  }

  async kanbanUnsubscribe(requestId?: string): Promise<KanbanUnsubscribePayload> {
    return this.sendNamespacedCorrelatedSessionRequest<"kanban.unsubscribe.response">({
      requestId,
      message: { type: "kanban.unsubscribe.request" },
    });
  }
