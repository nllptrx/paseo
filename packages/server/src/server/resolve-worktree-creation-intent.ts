...
function buildDefaultCheckoutRefs(
  params: Pick<PrCheckoutIntentParams, "changeRequestNumber" | "deps">,
  headRef: string,
) {
  if (params.deps.forge === "github") {
    return [{ remoteName: "origin", remoteRef: `refs/pull/${params.changeRequestNumber}/head` }];
  }
