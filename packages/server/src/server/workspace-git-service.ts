...
export class WorkspaceGitServiceImpl implements WorkspaceGitService {
  ...
  private async refreshGitHubSnapshot(
    ...
    target.latestForge = resolution ? { ...forgeSnapshot, forge: resolution.forge } : forgeSnapshot;
